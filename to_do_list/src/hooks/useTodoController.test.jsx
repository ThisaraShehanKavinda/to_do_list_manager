...
//This is generated By AI actually I don't Know testing part
...
describe('useTodoController Hook', () => {
  ...
  test('edits a todo item', () => {
    ...
    expect(editInput.value).toBe(firstTodo.textContent.replace('EditDelete', ''));
  ...
  test('deletes a todo item after confirmation', () => {
    render(<HookWrapper />);
    const firstTodoText = screen.getAllByRole('listitem')[0].textContent.replace('EditDelete', '');
